  ...
  return (
    <main className="p-8 flex flex-col min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-8 mt-8">
        ...
        <div className="lg:w-[400px] bg-gray-100 p-6 rounded shadow-md">
        ...
        <div className="flex-grow mt-8 lg:mt-0 min-h-full">
          <div className="bg-white shadow-md rounded p-6 min-h-full">
      ...
      {/* Version Number */}
      <div className="fixed left-0 bottom-0 ml-2 mb-2 text-gray-300">
        {version}
      </div>
    </main>
  );
